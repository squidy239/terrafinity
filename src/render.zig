...
pub fn RenderChunkFrame(chunkpos: [3]i32, cameraPos: zm.Vec3f, cameraUp: zm.Vec3f, cameraFront: zm.Vec3f, ver: []f32) !void {
...
pub fn InitRenderer() !void {
    ...
    gl.BufferData(gl.ELEMENT_ARRAY_BUFFER, @sizeOf(i32) * vertices.len, &indecies, gl.STATIC_DRAW);
