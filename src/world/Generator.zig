              ...
              for (row, 0..) |height, z| {
                  ...
                  if (chunk.blocks.blocks[x][y][z] == .Grass or chunk.blocks.blocks[x][y][z] == .Dirt) {
                      ...
                      if (true and treeChance < 0.000002) {
                          comptime var csteps: [10]World.Structures.Tree.Step = undefined;
                          comptime for (&csteps, 0..) |*step, r| {
                              step.* = switch (r) {
                                  0...0 => World.Structures.Tree.Step{
                                      .lengthPercent = 1.0,
                                      .radiusPercent = 1.0,
                                      .branchCountMax = 1,
                                      .branchCountMin = 1,
                                  ...
                                  1...2 => World.Structures.Tree.Step{
                                      .lengthPercent = 0.7,
                                      .radiusPercent = 0.5,
                                  ...
                                  3...5 => World.Structures.Tree.Step{
                                      .lengthPercent = 0.7,
                                      .radiusPercent = 0.7,
                                      .branchCountMax = 4,
                                      .branchCountMin = 3,
                                  ...
                                  6...10 => World.Structures.Tree.Step{
                                      .lengthPercent = 0.7,
                                      .radiusPercent = 0.7,
                                      .branchCountMax = 4,
                                      .branchCountMin = 3,
